...
const renderNav = () => {
    ...
    const headernavForLogo = document.createElement("h2");

    headernavForLogo.setAttribute("id", "logo");

    headernavForLogo.textContent = "HiShoppers"

    const headerNavForInfo = document.createElement("h3");

    headerNavForInfo.setAttribute("id", "about-us");

    headerNavForInfo.textContent = "About Us";

    headerDiv.appendChild(headernavForLogo);

    headerDiv.appendChild(headerNavForInfo);
...
const renderFooter = () =>{
    ...
    footerText.innerHTML = `&copy; HiShoppers. All rights reserved.`
